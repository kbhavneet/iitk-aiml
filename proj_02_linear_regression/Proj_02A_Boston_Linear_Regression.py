...
import pandas as pd # for manipulating the data frames

BosData = pd.read_csv('BostonHousing.csv')
X = BosData.iloc[:,0:11] # iloc is index location
y = BosData.iloc[:, 13] 
...
reg.fit(Xtrain, ytrain) # learning the coefficients h0 to h11
